...
export const OfficeCommissionTable: React.FC<OfficeCommissionTableProps> = ({
  commissions,
  onApprove,
  onPay,
  isLoading = false
            ...
            {currentCommissions.length === 0 ? (
              ...
              currentCommissions.map((commission) => (
                <TableRow key={commission.id}>
                  ...
                  <TableCell>{commission.office_name || '-'}</TableCell>
                  ...
                  <TableCell>
                    <CommissionStatusBadge status={commission.status as any} type="office" />
                  </TableCell>
