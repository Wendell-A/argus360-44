    ...
    <div className="p-8 space-y-6 bg-background min-h-full">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Gerencie as metas do escritório e individuais</p>
        </div>
            ...
            <CardContent className="p-4">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-foreground">{stats.averageProgress.toFixed(1)}%</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-foreground">{stats.totalGoals - stats.completedGoals}</p>
                </div>
              </div>
            </CardContent>
          </Card>
