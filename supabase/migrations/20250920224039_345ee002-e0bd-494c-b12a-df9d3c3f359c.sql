-- Corrigir ambiguidade nas funções - especificar tabela explicitamente
...
BEGIN
  ...
  IF admin_record.password_hash = extensions.crypt(p_password, admin_record.password_hash) THEN
    ...
    -- Atualizar último login e token - especificar colunas da tabela
...
-- Corrigir função de validação com alias de tabela
