...
INSERT INTO message_templates (tenant_id, name, content, category, variables, is_active)
SELECT 
  t.id as tenant_id,
  template_data.name,
...
{empresa_nome}',
      'birthday',
      '["cliente_nome", "empresa_nome", "vendedor_nome"]',
      true
    ),
    (
      'Atrasos no Pagamento',
...
{empresa_nome}',
      'payment_reminder',
      '["cliente_nome", "data_vencimento", "valor_parcela", "dias_atraso", "vendedor_nome", "empresa_nome"]',
      true
    ),
    (
      'Lembrete de Vencimentos',
...
{empresa_nome}',
      'due_date_reminder',
      '["cliente_nome", "valor_parcela", "data_vencimento", "dias_restantes", "vendedor_nome", "empresa_nome"]',
      true
    ),
    (
      'Contemplações',
...
{empresa_nome}',
      'contemplation',
      '["cliente_nome", "numero_grupo", "numero_cota", "valor_credito", "data_contemplacao", "vendedor_nome", "empresa_nome"]',
      true
    )
) AS template_data(name, content, category, variables, is_active);