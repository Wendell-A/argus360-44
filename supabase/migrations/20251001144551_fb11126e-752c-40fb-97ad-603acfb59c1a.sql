-- ============================================================
-- CORREÇÃO FORÇADA: Dashboard RPC - Bug de Colunas
-- Data: 01/10/2025
-- Objetivo: Garantir que função use nomes de colunas corretos
-- Correção: sale_value, seller_id, c.name
-- ============================================================

-- Remover função existente (força atualização completa)
DROP FUNCTION IF EXISTS public.get_dashboard_complete_optimized(uuid);

-- Recriar função com nomes de colunas corretos
...
-- Comentário de documentação com timestamp da correção
COMMENT ON FUNCTION public.get_dashboard_complete_optimized(uuid) 
IS 'Função otimizada para Dashboard - Corrigida em 01/10/2025 às 14:45 UTC - Usa sale_value, seller_id, c.name para compatibilidade com schema atual';